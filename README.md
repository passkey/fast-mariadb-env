...
[![Docker Automated build](https://img.shields.io/docker/automated/passkey/mariadb.svg?style=for-the-badge&logo=docker)](https://hub.docker.com/r/passkey/mariadb)
[![Docker Pulls](https://img.shields.io/docker/pulls/passkey/mariadb.svg?style=for-the-badge&logo=docker)](https://hub.docker.com/r/passkey/mariadb)
[![Docker Stars](https://img.shields.io/docker/stars/passkey/mariadb.svg?style=for-the-badge&logo=docker)](https://hub.docker.com/r/passkey/mariadb)
...
This Container image [(passkey/mariadb:11-alpine)](https://hub.docker.com/r/passkey/mariadb) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with [MariaDB v11.4.9](https://mariadb.org/) (MySQL Compatible) database server.
...
- `:version` Version tags e.g `:11-alpine`
...
```bash
docker run -it --name mariabdb -p 3306:3306 -v /var/lib/mysql:/var/lib/mysql -e MYSQL_DATABASE=mydb -e MYSQL_USER=myuser -e MYSQL_PASSWORD=mypwd -e MYSQL_ROOT_PASSWORD=qwer1234 passkey/mariadb:11-alpine
...
```bash
docker run --name mariadb -e MYSQL_ROOT_PASSWORD=qwer1234 -d passkey/mariadb:11-alpine --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
```
...
```yaml
mariadb:
  image: passkey/mariadb:11-alpine
  environment:
...
```
printf "qwer1234" | docker secret create MYSQL_ROOT_PASSWORD -
printf "mydb" | docker secret create MYSQL_DATABASE -
printf "myuser" | docker secret create MYSQL_USER -
printf "mypwd" | docker secret create MYSQL_PASSWORD -
...
- [Github - fast-mariadb-env](https://github.com/passkey/fast-mariadb-env)

## 🐳 Container Registries

- [Dockerhub - passkey/mariadb](https://hub.docker.com/r/passkey/mariadb)

## 🔗 Links

- [Dockerhub - Yoba alpine-mariadb](https://github.com/yobasystems/alpine-mariadb/)
